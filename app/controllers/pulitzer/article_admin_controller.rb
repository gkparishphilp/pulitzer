module Pulitzer
	class ArticleAdminController < ApplicationAdminController
		...
		private
			def article_params
				params.require( :article ).permit( :title, :subtitle, :avatar_caption, :slug_pref, :description, :content, :category_id, :status, :publish_at, :show_title, :is_commentable, :user_id, :tags, :tags_csv, :redirect_url, :avatar_attachment, :cover_attachment, { embedded_attachments: [], other_attachments: [] } )
			end
