...
module Pulitzer
	class PageAdminController < ApplicationAdminController
		...
		private
			def page_params
				params.require( :page ).permit( :title, :subtitle, :meta_title, :avatar_caption, :slug_pref, :description, :content, :status, :availability, :publish_at, :show_title, :is_sticky, :is_commentable, :user_id, :tags, :tags_csv, :layout, :template, :avatar_attachment, :cover_attachment, :meta_description, { embedded_attachments: [], other_attachments: [] } )
			end
